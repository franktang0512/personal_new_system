...
<!-- 開啟住址精靈視窗 -->
function nowAddr(){
  window.open("adress.php","住址精靈","width=630,height=300,toolbar=no,scrollbars=yes,status=yes,resizable=yes");
}
function nowAddr2(){
...
<div class="row">
  <div align="left"><span class="left">主選單>基本資料修改</span></div><div align="right"><span class="content"><font size=2 style="color:#FF0000">標示星號*者為必須填寫之欄位</font></span></div>
</div>
<div class="spacer"></div>
</div>
    <table width="645">
